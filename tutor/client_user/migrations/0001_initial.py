# Generated by Django 5.2 on 2025-05-02 01:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('persona_data', models.JSONField(blank=True, default=dict)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input_audio_duration', models.FloatField(blank=True, null=True)),
            ...
            options={
                'ordering': ['-timestamp'],
                'indexes': [models.Index(fields=['user', 'timestamp'], name='client_user_user_id_17d285_idx')],
            },
        ),
    ]
